...
methods = {'DoublySparseConditionedTL', 'ConditionedTransformLearning', 'Bresler', 'BreslerDoublySparse', 'DCT'};
...
paramsin.method = 0;
paramsin.lambda0 = 32e6;
paramsin.lambda = 10000;
paramsin.homotopy_steps = 10;
paramsin.debias_start = 300;
paramsin.clipping_eps = 10e-7;
paramsin.T1 = round((0.8)*(n^2));
paramsin.mu = 9e-10;
...
for method=1:n_methods
	...
	[IMU,paramsout]= DenoisingAlgorithm(I1,I7,paramsin);
	images{method} = IMU;
