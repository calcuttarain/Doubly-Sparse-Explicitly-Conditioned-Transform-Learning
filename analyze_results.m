...
chosen_timestamp = "2026-04-29_2120";
target_result = "1";
target_idx = 1; 

folder_path = fullfile("results", "results_" + chosen_timestamp); 

target_dir = fullfile('results', "plots_" + chosen_timestamp, 'general', "results_" + target_result, "idx_" + string(target_idx));
