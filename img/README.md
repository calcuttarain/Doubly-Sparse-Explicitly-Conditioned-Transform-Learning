Images provided by the series of papers:
...
`Baboon` from the [SIPI Imaga Database](https://sipi.usc.edu/database/database.php?volume=misc) was preprocessed in the same format as the above and added by the authors.
